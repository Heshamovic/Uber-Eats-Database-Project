            ...
            $.each(json, function (key, badword) {
                if ($.inArray(badword, words) === -1) {
                    self.elements.highlightWords.push(
                                                ...
                                                .click(function () { self.suggest(this); }).bind("contextmenu", function (e) { self.suggest(this); return false; })
        ...
        postJson: function (url, data, callback) {
            var xhr = $.ajax({
                ...
                error: function (XHR, status, error) {
                    alert('Sorry, there was an error processing spellchecker request to Google service.');
                },
